...
window.addEventListener("scroll", () => {
    ...
    if (rootStyles.getPropertyValue("--screenPosition") === "2" && window.scrollY / Math.max(document.body.scrollHeight, document.body.offsetHeight) * 100 < 10){
        ...
        if (scrollY === 0) {
            box1_2.style.clipPath = "circle(" + scrollY * modifier * 1.3 + "px at 0% 0%)";
        }
        else{
            box1_2.style.clipPath = "circle(" + scrollY * modifier * 1.3 + "px at 100% 100%)";
        }
...
buttonClosing.addEventListener("click", () => {
    ...
    document.getElementById("infoText").innerHTML = "Подивіться, як додати підпис до листів у Outlook <a id='infoLink' target='_blank' href='https://mih-my.sharepoint.com/:v:/g/personal/a_val_smirnov_metinvestholding_com/EVOocof76jpCtk3k5spHmkoBUauJlwd2E6MLBY3SHRZ_CQ?email=MetinvestGroupAllUsers%40metinvestholding.com&e=S0cB6z' style='color: #45a2ff; cursor: pointer;'>десктоп</a> або <a id='infoLink' target='_blank' href='https://mih-my.sharepoint.com/:v:/g/personal/a_val_smirnov_metinvestholding_com/EQOb0mOyzjlHk5XmKiCay7oBUgYe_3P8oxAAaQNXgrtlqg?email=MetinvestGroupAllUsers%40metinvestholding.com&e=W2eXTq' style='color: #45a2ff; cursor: pointer;'>онлайн</a>.";
