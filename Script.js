...
let departmentMargin = 55;
let companyInCardMargin = 79.94;
let addressArray = [];
let qr = {};
let canvasImg = {};
    ...
    for (let i = 0; i < assetsButtons.length; i++){
        assetsButtons[i].addEventListener("click", () => {
            ...
            if (companyInCard.getBoundingClientRect().height > 20) {
                ...
                companyInCard.style.marginTop = "138px";
                companyInCardMargin = 79.94;
            }
...
mobilePhone.addEventListener("input", function(e) {
    ...
    mobilePhoneInCard.innerHTML = "Моб.: " + mobilePhone.value;
    mobilePhoneInCard.style.color = "black";
    mobilePhoneClosingText.textContent = "Моб.: " + mobilePhone.value;
...
function generatePDF() {
    ...
    var content = [
        ...
        },
	    {
            ...
            fontSize: 8,
	        bold: true,
	        margin: [0, companyInCardMargin, 110.55, 0]
        },
	    {
            text: webPageInCard.innerHTML,
            fontSize: 6,
	        absolutePosition: { x: 14.17, y: 104.6 }
        },
	    {
        ...
        },
	    {
            ...
            fontSize: 8,
            absolutePosition: { x: 141.73 , y: 21.26 },
	        bold: true
        },
	    {
            text: positionInCard.innerHTML,
            fontSize: 6,
	        absolutePosition: { x: 141.73, y: 45.35 }
        },
	    {
            text: departmentInCard.innerHTML,
            fontSize: 6,
	        absolutePosition: { x: 141.73, y: departmentMargin }
        },
	    {
            text: mobilePhoneInCard.innerHTML,
            fontSize: 6,
	        absolutePosition: { x: 141.73, y: 113.39 }
        },
	    {
            text: workPhoneInCard.innerHTML,
            fontSize: 6,
	        absolutePosition: { x: 141.73, y: 104.6 }
        },
	    {
            text: addressArray[1],
            fontSize: 6,
	        absolutePosition: { x: 141.73, y: 95.81 }
        },
	    {
            text: addressArray[0] + ",",
            fontSize: 6,
	        absolutePosition: { x: 141.73, y: 87.02 }
        }
    ];
